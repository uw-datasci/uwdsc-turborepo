...
/**
 * @deprecated Use `renderTextField` with variant: "auth" instead
 */
export const renderLoginTextField = <T extends Record<string, any>>(
  placeholder: string,
  inputProps?: Partial<ComponentProps<typeof Input>>
) => renderTextField<T>(placeholder, { variant: "auth", inputProps });
...
/**
 * @deprecated Use `renderSelectField` with variant: "auth" instead
 */
export const renderRegistrationSelectField = <T extends Record<string, any>>(
  placeholder: string,
  options: string[]
) => renderSelectField<T>(placeholder, options, { variant: "auth" });

/**
 * @deprecated Use `renderTextAreaField` with variant: "auth" instead
 */
export const renderRegistrationTextAreaField = <T extends Record<string, any>>(
  placeholder: string,
  textareaProps?: Partial<ComponentProps<typeof Textarea>>
) => renderTextAreaField<T>(placeholder, { variant: "auth", textareaProps });
 ...
 * Matches old ExecAppFormHelpers API
 */

...
import {
  ...
  renderTextAreaFieldWithLabel as renderTextAreaField,
      ...
      <Form {...form}>
        ...
        <Card className="border-white/20 bg-slate-800">
          ...
          <CardContent className="space-y-6">
            ...
            {position1Data && (
              <>
                {position1Data.questions.map((q, index) => (
                  <FormField
                    key={q.id}
                    control={form.control}
        ...
        <Card className="border-white/20 bg-slate-800">
          ...
          <CardContent className="space-y-6">
            ...
            {position2Data && (
              <>
                {position2Data.questions.map((q, index) => (
                  <FormField
                    key={q.id}
                    control={form.control}
        ...
        <Card className="border-white/20 bg-slate-800">
          ...
          <CardContent className="space-y-6">
            ...
            {position3Data && (
              <>
                {position3Data.questions.map((q, index) => (
                  <FormField
                    key={q.id}
                    control={form.control}

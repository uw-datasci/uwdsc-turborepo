...
Backend services specific to the CXC competition app.
...
- **ApplicationService** - Competition applications
- **TeamService** - Team management
- **EventService** - Competition events
...
Each app-specific package has its own Prisma schema:
...
- [Database Setup](/guides/database) - Work with Prisma

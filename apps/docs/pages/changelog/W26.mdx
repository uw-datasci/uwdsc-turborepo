...
- Results page now displays informative message for users who didn't submit applications
- Users with draft applications see explanation about missed deadline
- Improved user experience with clear next steps messaging

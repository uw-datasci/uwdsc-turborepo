...
type PriorHackathonExperience =
  AppFormValues["prior_hackathon_experience"][number];

const options: PriorHackathonExperience[] = [
  "None",
  "Hacker",
  "Judge",
  "Mentor",
    ...
    <div className="space-y-6">
      <div className="mb-5 flex flex-col gap-3 px-4">
        ...
        <p className="mb-2 block text-base text-white">
          Answer questions regarding your hackathon experience, upload your
          resume, and provide links to your Github, Linkedin, etc.
        </p>
      </div>
      <Form {...form}>
